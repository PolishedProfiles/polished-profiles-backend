...
{{LinkedIn Profile URL}} | {{Github Profile URL}}
  ...
  {{Project1 Name}}, {{Project1 Date}} - {{Project1 URL}}
  {{Project1 Description}}
  Built with {{Project1 Tools}}
  
  {{Project2 Name}}, {{Project2 Date}} - {{Project2 URL}}
  {{Project2 Description}}
  Built with {{Project2 Tools}}
  
  {{Project3 Name}}, {{Project3 Date}} - {{Project3 URL}}
  {{Project3 Description}}
  Built with {{Project3 Tools}}
  
  {{Project4 Name}}, {{Project4 Date}} - {{Project4 URL}}
  {{Project4 Description}}
  Built with {{Project4 Tools}}
  
  {{Project5 Name}}, {{Project5 Date}} - {{Project5 URL}}
  {{Project5 Description}}
  Built with {{Project5 Tools}}
  
  EDUCATION
  
  {{Education1 Name}}, {{Education1 Location}}
  ...
  {{Experience1 Title}} - {{Experience1 Dates}}
  {{Experience1 Description}}
  
  {{Experience2 Title}} - {{Experience2 Dates}}
